...
<?php
 ...
 ?>
        ...
        .card{ border: 1px solid #dee2e6; transition: box-shadow 0.3s ease; }

        .card-body{ background-color: #fff; border-top: 1px solid #dee2e6; }
      ...
      <a href="vehicles" class="card-link">
       <div class="card card-h-100">
        <div class="card-body">
          ...
          <h2 class="mb-0 text-muted lh-1 d-block text-truncate text-center">Total Task</h2>
        </div>
       </div>
      </a>
    </div>
      ...
      <a href="bill-entry" class="card-link">
       <div class="card card-h-100">
         <div class="card-body">
          ...
          <h2 class="mb-0 text-muted lh-1 d-block text-truncate text-center">Task In Process</h2>
         </div>
       </div>
      </a>
    </div>
      ...
      <a href="bill-list" class="card-link">
       <div class="card card-h-100">
        <div class="card-body">
         ...
         <h2 class="mb-0 text-muted lh-1 d-block text-truncate text-center">Task Done</h2>
        </div>
       </div>
      </a>
    </div>

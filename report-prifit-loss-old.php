            ...
            <div class="container-fluid">
                ...
                <div class="card">
                                    ...
                                    <table class="table table-bordered table-striped">
                                        ...
                                        while ($row2 = $query2->fetch_array()) { ?>
                                            <tr>
                                                <td><?php echo $slno;
                                                    $slno++ ?></td>
                                                <td><?php echo 'QUOT-' . $row2['id'] ?></td>
                                                <td><?php echo getGuestName($row2['guest_id']) ?></td>
                                                <td><?php echo $row2['pack_total'];$total_amount+=$row2['pack_total']; ?></td>
                                            </tr>
                                        <?php } ?>
                                        <tr>
                                            <td colspan="4"><b>Total Qotation Amount :</b><?php echo $total_amount ?></td>
                                        </tr>
                                    </table>
                                </div>
                            </div>
                                ...
                                <table class="table table-bordered table-striped">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?php $total_paid_amount += $row['paid_amount'];
                                    ...
                                    <tr>
                                        <td colspan="4"></td>
                                        <td colspan="2" class="text-start"><b>Total Amount Paid :<?php echo $total_paid_amount ?></b></td>
                    ...
                    <div class="card-footer">
                        <h4>Total Due  :<?php $prol=$total_amount-$total_paid_amount; echo ($prol>0)?'<span class="text-success">'.$prol.'</span>':'<span class="text-danger">'.$prol.'</span>' ?></h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
